  ...
  return (
    ...
    >
      ...
      <div>
        ...
        by {siteConfig.personalInfo.fullName}
      </div>
    </footer>
  );
};
...
const socialLinks = [
  {
    ...
    link: siteConfig.socialLinks.github.url,
    svg: (
      <svg
        xmlns="http://www.w3.org/2000/svg"
        width="24"
  ...
  {
    id: 3,
    title: siteConfig.socialLinks.twitter.title,
    link: siteConfig.socialLinks.twitter.url,
    svg: (
      <svg
        xmlns="http://www.w3.org/2000/svg"
        width="24"
