...
const socialLinks = [
  {
    id: 1,
    title: "Arjun Subbiah's Github Profile",
    link: "https://github.com/arjunsubbiah",
    svg: (
      <svg
  ...
  {
    id: 2,
    title: "Arjun Subbiah's LinkedIn Profile",
    link: "https://www.linkedin.com/in/arjun-subbiah-b19330a6/",
    svg: (
      <svg
        xmlns="http://www.w3.org/2000/svg"
        width="24"
  ...
  {
    id: 3,
    title: "Check Arjun Subbiah on Dev.to",
    link: "https://dev.to/arjunsubbiah",
    svg: (
      <svg
        xmlns="http://www.w3.org/2000/svg"
        width="24"
  ...
  {
    id: 4,
    title: "Arjun Subbiah's Profile on Facebook",
    link: "https://www.facebook.com/arjunsubbiah",
    svg: (
      <svg
        xmlns="http://www.w3.org/2000/svg"
        width="24"
