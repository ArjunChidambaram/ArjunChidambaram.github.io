...
const NavIcon: React.FC<{ svgPath?: string }> = ({ svgPath }) => {
    ...
    <header className="md:flex">
      ...
      >
        <div className="w-full h-full mx-auto max-w-6xl flex items-center justify-between">
          ...
          >
            {siteConfig.personalInfo.brandName}
            <span className="text-marrsgreen dark:text-carrigreen">.Subbiah</span>
          </Link>
                    ...
                    {navLink.isDynamic ? (
                      ...
                      >
                        <span className="md:hidden">
                          <NavIcon svgPath={navLink.svgPath} />
                        </span>
